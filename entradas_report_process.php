...
<?php
  if(isset($_POST['submit'])){
    ...
    if(empty($errors)):
      ...
      $results      = find_entrar_by_dates($start_date,$end_date);
    else:
       ...
       <table class="table table-border">
        ...
        <tbody>
          <?php foreach($results as $result): ?>
           ...
           <td class="text-center"><?php echo remove_junk(ucfirst($result['codigo']));?></td>
           <td class="text-center"><?php echo remove_junk(ucfirst($result['factura']));?></td>
           <td class="text-center"><?php echo remove_junk(ucfirst($result['name']));?></td>
           <td class="text-center"><?php echo remove_junk($result['modelo']);?></td>
           <td class="text-center"><?php echo remove_junk($result['serie']);?></td>
           <td class="text-center"><?php echo remove_junk($result['entrada']);?></td>
          </tr>
        <?php endforeach; ?>
        </tbody>
        <tfoot>
